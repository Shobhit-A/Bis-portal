...
const DOCUMENTS = [
  { no: 1, doc: 'Product Technical Catalogue', requirement: 'Mandatory' },
  { no: 2, doc: 'Authorization Letter', requirement: 'Mandatory' },
  { no: 3, doc: 'RF Test Report', requirement: 'Mandatory' },
];
...
export default function DocumentChecklist({ formData, updateSection, getDocForField, onDocUploaded, onDocRemoved, isSubmitted }) {
  ...
  return (
    <div className="space-y-6">
      <div className="card">
        <div className="section-header">Documents Required for WPC ETA Certification</div>
        <div className="p-6">
